...
class FBPlayer(pygame.sprite.Sprite):
  ...
  def performAction(self, team):
    if self.state == State.ATTACK:
      ...
      shouldMoveRight = self.rect.centerx - self.defaultX * coefficient + INTERVAL * coefficient \
                        < team.player.rect.centerx - team.player.defaultX * coefficient
      shouldMoveLeft = self.rect.centerx - self.defaultX * coefficient - INTERVAL * coefficient \
                       > team.player.rect.centerx - team.player.defaultX * coefficient
